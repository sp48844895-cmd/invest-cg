...
@section('page-title', 'Add New Contact Person')

@section('content')
<div class="admin-card">
    <div class="card-header">
        <h5 class="card-title">Add New Contact Person</h5>
        <a href="{{ route('admin.contact-persons.index') }}" class="btn-secondary-admin">
            <i class="bi bi-arrow-left"></i> Back to List
        </a>
    </div>

    <form method="POST" action="{{ route('admin.contact-persons.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('mobile') is-invalid @enderror"
                                   id="mobile" name="mobile" value="{{ old('mobile') }}" placeholder="e.g., 9876543210">
                            @error('mobile')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3" id="sectors-field" style="display: none;">
                    ...
                    <input type="text" class="form-control @error('sectors') is-invalid @enderror"
                           id="sectors" name="sectors" value="{{ old('sectors') }}"
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-2">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="order_position" id="order_position_first" value="first" checked>
                                <label class="form-check-label" for="order_position_first">
                                    First
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="order_position" id="order_position_after" value="after">
                    ...
                    <div id="order_reference_field" class="mb-3" style="display: none;">
        ...
        <div class="d-flex gap-2">
            <button type="submit" class="btn-primary-admin">
                <i class="bi bi-check-circle"></i> Create Contact Person
            </button>
            <a href="{{ route('admin.contact-persons.index') }}" class="btn-secondary-admin">
