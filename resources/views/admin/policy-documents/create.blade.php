...
@section('page-title', 'Add Policy Document')

@section('content')
<div class="admin-card">
    <div class="card-header">
        <h5 class="card-title">Add New Policy Document</h5>
        <a href="{{ route('admin.policy-documents.index') }}" class="btn-secondary-admin">
            <i class="bi bi-arrow-left"></i> Back
        </a>
    </div>

    <form action="{{ route('admin.policy-documents.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="policy_period" class="form-control @error('policy_period') is-invalid @enderror" 
                           value="{{ old('policy_period') }}" placeholder="e.g., 2024-30, 2019-24">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="file" name="file" class="form-control @error('file') is-invalid @enderror" 
                           accept=".pdf" required>
                    <small class="text-muted">No size limit</small>
                    @error('file')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
