...
@section('content')
  ...
  <section class="sector-hero">
    <img src="{{ asset('assets/img/sectors/textile-banner.jpg') }}" class="hero-video" alt="">
    <div class="hero-gradient-overlay"></div>
    <div class="container">
      <div class="hero-content-wrapper">
        <div class="hero-text">
          <h1 class="hero-title">Textile</h1>
          <div class="hero-actions">
            <a href="../storage/policy-brochure/Textile & Garments Booklet.pdf" target="_blank" class="cta-btn secondary">
    ...
    <div class="container">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">
          Discover comprehensive incentive packages and benefits tailored for textile investments
        </p>
      </div>
      ...
      <div class="opportunities-grid">
        ...
        <div class="opportunity-card featured"
          onclick="openModal('MSME', '{{ asset('assets/img/sectors/textile_msme.jpg') }}', [])">
        ...
        <div class="opportunity-card premium"
          onclick="openModal('Large Enterprise', '{{ asset('assets/img/sectors/textile_special.jpg') }}', [])">
          <div class="opportunity-header">
            <div class="opportunity-icon-box">
        ...
        <div class="opportunity-card document">
          <a href="{{ Storage::url('pdfs/sample-sheet/Textile Sector_ Incentives on Investment (Illustrative).pdf') }}"
            download="Textile Sector: Incentives on Investment (Illustrative)" class="card-full-link">
            <div class="opportunity-header">
              <div class="opportunity-icon-box">
  ...
  <section class="ecosystem-section">
    <div class="container">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">Strategic advantages that make Chhattisgarh an ideal destination for textile
          investments</p>
      </div>
        ...
        <div class="feature-row">
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <p>Textile park (92 acres) and Ready-Made Garment Park (20 acres) in Nava Raipur, and Textile Park (111
                acres) in Janjgir-Champa</p>
            </div>
          </div>
          ...
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>Rich Silk Production</h4>
              <p>Leading producers of tussar and kosa silks in the country</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>Market Access</h4>
              <p>Easy access to key markets across seven states</p>
            </div>
          </div>
        </div>
        ...
        <div class="feature-row">
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>Skilled Workforce Pipeline</h4>
              <p>Presence of Apparel Training and Design Centres</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>Thriving Handloom Sector</h4>
              <p>301 weaver societies and over 20,100 looms</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="partners-section">
    <div class="container-fluid text-center">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">Join the growing community of textile leaders choosing Chhattisgarh</p>
      </div>
            ...
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/t1.jpg') }}" alt="Partner 1">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/t2.jpg') }}" alt="Partner 2">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/t3.jpg') }}" alt="Partner 3">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/t4.jpg') }}" alt="Partner 4">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/t5.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/t6.jpg') }}" alt="Partner6">
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    function openModal(title, image, points) {
      let updatedPoints = {
        ...
        "Large Enterprise": [
          ...
          "75% EPF reimbursement for 5 years, up to 2% of FCI per year",
          "Employment assistance - 6,000 for females and 5,000 for males per month for 5 years",
          "Training cost reimbursement: one month wage or Rs. 15,000 per employee",
          "25% subsidy on R&D plant and machinery up to maximum Rs. 1 Crores",
    ...
    document.addEventListener("DOMContentLoaded", () => {
      const playButton = document.getElementById("play-button_textile");
      const videoPopup = document.getElementById("video-popup_textile");
      const popupVideo = document.getElementById("popup-video_textile");
      const closeButtons = document.querySelectorAll("#close-popup_textile");

      if (playButton) {
        playButton.addEventListener("click", () => {
          videoPopup.classList.add('active');
          popupVideo.setAttribute("src", "assets/videos/Textile.mp4");
          popupVideo.play();
        });
      }
