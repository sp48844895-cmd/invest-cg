...
@section('content')
  ...
  <section class="sector-hero">
    <img src="{{ asset('assets/img/sectors/pharma_banner.jpg') }}" class="hero-video" alt="">
    <div class="hero-gradient-overlay"></div>
    <div class="container">
      <div class="hero-content-wrapper">
        <div class="hero-text">
          <h1 class="hero-title">Pharma & Medical Devices</h1>
          <div class="hero-actions">
            <a href="../storage/policy-brochure/Pharma & Medical Device Booklet.pdf" target="_blank"
  ...
  <div class="breadcrumb-nav">
    <div class="container breadcrumb-container">
      ...
      <span>›</span>
      <a href="#" class="active">Pharma & Medical Devices</a>
      <span>›</span>
    ...
    <div class="container">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">
          Discover comprehensive incentive packages and benefits tailored for pharma and medical devices investments
        </p>
      </div>
      ...
      <div class="opportunities-grid">
        ...
        <div class="opportunity-card featured"
          onclick="openModal('MSME', '{{ asset('assets/img/sectors/pharma_msme.jpg') }}', [])">
        ...
        <div class="opportunity-card premium"
          onclick="openModal('Large Enterprise', '{{ asset('assets/img/sectors/pharma_special.jpg') }}', [])">
          <div class="opportunity-header">
            <div class="opportunity-icon-box">
        ...
        <div class="opportunity-card document">
          <a href="{{ Storage::url('pdfs/sample-sheet/Pharma Sector_ Incentives on Investment (Illustrative).pdf') }}"
            download="Pharma Sector: Incentives on Investment (Illustrative)" class="card-full-link">
            <div class="opportunity-header">
              <div class="opportunity-icon-box">
  ...
  <section class="ecosystem-section">
    <div class="container">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">Strategic advantages that make Chhattisgarh an ideal destination for pharma and
          medical devices investments</p>
      </div>
        ...
        <div class="feature-row">
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>Pharma Park</h4>
              <p>Pharma park (141 acres) in Nava Raipur</p>
            </div>
          </div>
          ...
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <p>Availability of medicinal plants & herbs - more than 1525 varieties of medicinal plants</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <p>Pharmacy related academic institutions providing industry ready workforce</p>
            </div>
          </div>
        </div>
        ...
        <div class="feature-row">
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <p>Government focus on enhancing healthcare infrastructure and access to medicines</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <p>Incentives for R&D centres and clinical trials</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="partners-section">
    <div class="container-fluid text-center">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">Join the growing community of pharma and medical devices leaders choosing
          Chhattisgarh</p>
      </div>
            ...
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/img-1.jpg') }}" alt="Partner 1">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/img-2.jpg') }}" alt="Partner 2">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/img-3.jpg') }}" alt="Partner 3">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/img-4.jpg') }}" alt="Partner 4">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/img-5.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    function openModal(title, image, points) {
      let updatedPoints = {
        "MSME": [
          ...
          "Interest Subsidy: 45%-55% for 6 to 8 years, up to Rs. 50 lakhs per year",
        ...
        "Large Enterprise": [
          ...
          "20% subsidy on R&D plant and machinery up to maximum Rs. 3 Crores",
          "50% ETP subsidy up to Rs. 1 crore",
          "50% subsidy on clinical trials up to 1 crore per trial limited to 5 trials",
          "Among other subsidies"
        ]
      };
    ...
    document.addEventListener("DOMContentLoaded", () => {
      const playButton = document.getElementById("play-button_pharma");
      const videoPopup = document.getElementById("video-popup_pharma");
      const popupVideo = document.getElementById("popup-video_pharma");
      const closeButtons = document.querySelectorAll("#close-popup_pharma");

      if (playButton) {
        playButton.addEventListener("click", () => {
          videoPopup.classList.add('active');
          popupVideo.setAttribute("src", "assets/videos/Pharma.mp4");
          popupVideo.play();
        });
      }
