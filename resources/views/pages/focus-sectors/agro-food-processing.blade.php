...
@section('content')
  ...
  <section class="sector-hero">
    <img src="{{ asset('assets/img/sectors/agro_banner.jpg') }}" class="hero-video" alt="">
    <div class="hero-gradient-overlay"></div>
    <div class="container">
      <div class="hero-content-wrapper">
        <div class="hero-text">
          <h1 class="hero-title">Agro & Food Processing</h1>
          <div class="hero-actions">
            <a href="../storage/policy-brochure/Agro & Food Processing Booklet.pdf" target="_blank"
  ...
  <div class="breadcrumb-nav">
    <div class="container breadcrumb-container">
      ...
      <span>›</span>
      <a href="#" class="active">Agro & Food Processing</a>
      <span>›</span>
    ...
    <div class="container">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">
          Discover comprehensive incentive packages and benefits tailored for agro and food processing investments
        </p>
      </div>
      ...
      <div class="opportunities-grid">
        ...
        <div class="opportunity-card featured"
          onclick="openModal('MSME', '{{ asset('assets/img/sectors/food_msme.jpg') }}', [])">
        ...
        <div class="opportunity-card premium"
          onclick="openModal('Large Enterprise', '{{ asset('assets/img/sectors/food_special.jpg') }}', [])">
          <div class="opportunity-header">
            <div class="opportunity-icon-box">
        ...
        <div class="opportunity-card document">
          <a href="{{ Storage::url('pdfs/sample-sheet/Agro & Food Processing Sector_ Incentives on Investment (Illustrative).pdf') }}"
            download="Agro & Food Processing Sector: Incentives on Investment (Illustrative)" class="card-full-link">
            <div class="opportunity-header">
              <div class="opportunity-icon-box">
  ...
  <section class="ecosystem-section">
    <div class="container">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">Strategic advantages that make Chhattisgarh an ideal destination for agro and food
          processing investments</p>
      </div>
        ...
        <div class="feature-row">
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <p>Availability of agriculture, horticulture, dairy, and minor forest produce</p>
            </div>
          </div>
          ...
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>Rice Export</h4>
              <p>Leading exporter of non-basmati rice</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>Food Parks</h4>
              <p>10+ well-equipped food parks</p>
            </div>
          </div>
        </div>
        ...
        <div class="feature-row">
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <p>Presence of Agro and food processing related educational institutions</p>
            </div>
          </div>
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>Testing Labs</h4>
              <p>Quality control labs for fertilizer, seed & soil testing labs, and food testing labs</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="partners-section">
    <div class="container-fluid text-center">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">Join the growing community of agro and food processing leaders choosing
          Chhattisgarh</p>
      </div>
            ...
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a1.jpg') }}" alt="Partner 1">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a2.jpg') }}" alt="Partner 2">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a3.jpg') }}" alt="Partner 3">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a4.jpg') }}" alt="Partner 4">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a5.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a6.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a7.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a8.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a9.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a10.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/a11.jpg') }}" alt="Partner 5">
                </div>
              </div>
            </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <a href="{{ route('focus-sectors.show', 'defence-aerospace') }}" class="sector-mini-card">
                ...
                <span class="sector-mini-name">Defense & Aerospace</span>
              </a>
            </div>
            <div class="swiper-slide">
  ...
  <script>
    ...
    function openModal(title, image, points) {
      let updatedPoints = {
        "MSME": [
          ...
          "Mandi tax exemption up to Rs. 5 Crores per year for 5 years",
        ...
        "Large Enterprise": [
          ...
          "Training cost reimbursement: one month wage or Rs. 15,000 per employee",
          "25% subsidy on R&D plant and machinery up to maximum Rs. 1 Crore",
          "50% ETP subsidy up to Rs. 1 crore",
          "Transport subsidy for export - 75% for 10 years up to 35% of the FCI",
          "Among other subsidies"
        ]
      };
    ...
    document.addEventListener("DOMContentLoaded", () => {
      const playButton = document.getElementById("play-button_agro");
      const videoPopup = document.getElementById("video-popup_agro");
      const popupVideo = document.getElementById("popup-video_agro");
      const closeButtons = document.querySelectorAll("#close-popup_agro");

      if (playButton) {
        playButton.addEventListener("click", () => {
          videoPopup.classList.add('active');
          popupVideo.setAttribute("src", "assets/videos/Agro.mp4");
          popupVideo.play();
        });
      }
