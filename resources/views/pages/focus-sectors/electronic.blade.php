...
@section('content')
  ...
  <section class="sector-hero">
    <img src="{{ asset('assets/img/sectors/electronic_banner.jpg') }}" class="hero-video" alt="">
    <div class="hero-gradient-overlay"></div>
    <div class="container">
      <div class="hero-content-wrapper">
        <div class="hero-text">
          <h1 class="hero-title">Electrical and Electronics</h1>
          <div class="hero-actions">
            <a href="../storage/policy-brochure/Electrical & Electronics Booklet.pdf" target="_blank"
  ...
  <div class="breadcrumb-nav">
    <div class="container breadcrumb-container">
      ...
      <span>›</span>
      <a href="#" class="active">Electrical and Electronics</a>
      <span>›</span>
    ...
    <div class="container">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">
          Discover comprehensive incentive packages and benefits tailored for electrical and electronics investments
        </p>
      </div>
      ...
      <div class="opportunities-grid">
        ...
        <div class="opportunity-card featured"
          onclick="openModal('MSME', '{{ asset('assets/img/sectors/ev_msme.jpg') }}', [])">
        ...
        <div class="opportunity-card premium"
          onclick="openModal('Large Enterprise', '{{ asset('assets/img/sectors/ev_special.jpg') }}', [])">
          <div class="opportunity-header">
            <div class="opportunity-icon-box">
        ...
        <div class="opportunity-card document">
          <a href="{{ Storage::url('pdfs/sample-sheet/Electronics & Electrical Sector_ Incentives on Investment (Illustrative).pdf') }}"
            download="Electronics Sector: Incentives on Investment (Illustrative)" class="card-full-link">
            <div class="opportunity-header">
              <div class="opportunity-icon-box">
  ...
  <section class="ecosystem-section">
    <div class="container">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">Strategic advantages that make Chhattisgarh an ideal destination for electrical and
          electronics investments</p>
      </div>
        ...
        <div class="feature-row">
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <p>Electronics Manufacturing Cluster in Nava Raipur and other well-established industrial areas</p>
            </div>
          </div>
          ...
          <div class="feature-item">
            ...
            <div class="feature-content-centered">
              ...
              <h4>New EMC</h4>
              <p>New EMC proposed in Rajnandgaon</p>
            </div>
          </div>
          <div class="feature-item">
  ...
  <section class="partners-section">
    <div class="container-fluid text-center">
      <div class="section-header-modern">
        ...
        <p class="section-desc-modern">Join the growing community of electrical and electronics leaders choosing
          Chhattisgarh</p>
      </div>
            ...
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/e1.png') }}" alt="Partner 1">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/e2.png') }}" alt="Partner 2">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/e3.png') }}" alt="Partner 3">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/e4.png') }}" alt="Partner 4">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/e5.png') }}" alt="Partner 5">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner-card">
                <div class="partner-logo">
                  <img src="{{ asset('assets/img/partners/e6.png') }}" alt="Partner 6">
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      const playButton = document.getElementById("play-button_electronics");
      const videoPopup = document.getElementById("video-popup_electronics");
      const popupVideo = document.getElementById("popup-video_electronics");
      const closeButtons = document.querySelectorAll("#close-popup_electronics");

      if (playButton) {
        playButton.addEventListener("click", () => {
          videoPopup.classList.add('active');
          popupVideo.setAttribute("src", "assets/videos/Electronics.mp4");
          popupVideo.play();
        });
      }
